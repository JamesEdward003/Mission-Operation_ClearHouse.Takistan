...
{
    if ((side _x == playerSide) and ((_x distance _Player) < 50)) then
    {
...
//	hint format ["%1",_medicarray];
	uisleep .01;
    {if ((vehicle _x == _x) && (_x != _Player) && (_x in _MedicArray)) then {_ValidArray = _ValidArray + [_x];};} forEach _ValidArrayPlayerSide;
...
// =======================================================================================
	...
	_validMedicArray 	= _Player nearEntities [_MedicArray, 50];
