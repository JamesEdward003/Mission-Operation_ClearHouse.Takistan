...
uisleep 0.25;   
	...
	//(driver _vehicle) commandMove _dropPos;
	//(driver _vehicle) doMove _dropPos;
	...
	_wp0 setWaypointStatements ["true","{commandGetOut [_x]} forEach units group this; (vehicle this) VehicleChat 'Prepare to unload!';"];
	...
	//(driver _vehicle) commandMove _hPadPos;
	//(driver _vehicle) doMove _hPadPos;
